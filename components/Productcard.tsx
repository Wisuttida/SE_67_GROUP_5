  ...
  return (
    <div className="bg-gray-100 p-4 rounded-lg shadow-lg">
      ...
      <div className="flex items-center mb-3">
        <img src={product.shopImage} alt={product.shopName} className="w-10 h-10 rounded-full mr-2" />
        <span className="text-sm font-semibold text-gray-800">{product.shopName}</span>
      </div>

      <Link href={`/product/${product.productId}`} passHref>
        <img src="/path/to/product1.jpg" alt={product.name} className="w-full h-48 object-cover rounded-lg" />
